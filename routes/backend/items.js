...
router.get('/add(/:id)?', function(req, res, next) {
    ...
    if (req.params.id === undefined) {
        res.render('inc/admin/items/add', { layout: __layoutAdmin, title: 'add page', data, validatorErr, baselink, col });
    } else {
        
        var data = {};
        ItemsModel.findById(req.params.id, (err, result) => {
            data = result;
            res.render('inc/admin/items/add', { layout: __layoutAdmin, title: 'edit page', data, validatorErr, baselink, col });
        });
